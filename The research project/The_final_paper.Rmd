...
#excel is way better on doing the dummy variable
...
########## entire data without covid shocl
...
#the Var data
Var_all_data <- cbind(stationary_Can_month_housing_sell.ts, Stationary_CPI.ts, HPI, stationary_CA_GDP.ts, unemploymnet 
