...
#(2023 - 2018)
n.end <- 2020
n_test <- 12 * (2023 - 2020) #the times we need go
n_models <- 4  
h.val <- 1 
...
Bank_rate.st <- get_cansim_vector(Bank_rate_raw, start_time = "2006/11/01", end_time = "2022/12/31")
...
The_conditional_forecasting_1<- auto.arima(Can_month_housing_sell.ts, xreg = Bank_rate.ts_2,
                                  approximation = FALSE, parallel = TRUE, stepwise = FALSE,
                                  num.cores = 10, start.p = 0, start.q = 0, start.P = 0, 
                                  start.Q = 0, max.Q = 5, max.P = 5, max.D = 5,
                                  max.d = 5, max.p = 5, max.q = 5)
...
The_Var_model <- forecast(The_evil_model, h = 30)
