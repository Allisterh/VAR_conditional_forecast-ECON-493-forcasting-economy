...
This following code include the data collection for the 495 economic forecast. 1. Consumer Price Index, monthly, not seasonally adjusted (<https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=1810000401>) 2. new housing price (note:stat say it is level E data) <https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=1810020501> v111955443
